...
const AI_PRACTICE_SESSION_SCOPE_RE = /(?:\.qoder|\.codex|\.claude|\.cursor|\.qwen|\.copilot|\.pi\b|\.kimi-code|\.kimi|qoder|codex|claude|cursor|qwen|copilot|\bpi\b|kimi|session-analysis|session sources|session evidence|会话分析|会话证据)/i;
