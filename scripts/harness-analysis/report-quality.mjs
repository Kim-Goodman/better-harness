...
const AI_PRACTICE_SESSION_SCOPE_RE = /(?:\.qoder|\.codex|\.claude|\.cursor|\.qwen|\.copilot|\.pi\b|\.workbuddy|\.kimi-code|\.kimi|qoder|codex|claude|cursor|qwen|copilot|\bpi\b|workbuddy|kimi|session-analysis|session sources|session evidence|会话分析|会话证据)/i;
