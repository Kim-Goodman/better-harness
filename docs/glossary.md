...
| `session-analysis` | Normalizes Qoder, Codex, Claude, Cursor, Qwen, Copilot, Pi, or Kimi Code agent session behavior into evidence. | [scripts/session-analysis](../scripts/session-analysis) |
